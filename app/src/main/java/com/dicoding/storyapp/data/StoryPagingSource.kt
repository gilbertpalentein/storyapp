...
class StoryPagingSource(private val apiService: ApiService) :
    PagingSource<Int, UserStoryModel>() {
    override fun getRefreshKey(state: PagingState<Int, UserStoryModel>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, UserStoryModel> {
        return try {
